...
public class TaskService {
    public static void addTask(String title, String description, Date dueDate) throws InvalidEntityException, EntityNotFoundException {
        Task task = new Task(title, description, dueDate);
        task.setStatus(Task.Status.NotStarted);
        Database.add(task);
    }

    public static void setAsInProgress(int taskId) throws InvalidEntityException, EntityNotFoundException {
